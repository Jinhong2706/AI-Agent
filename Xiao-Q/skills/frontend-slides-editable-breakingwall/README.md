...
市场发布包不包含 PNG/JPEG 等二进制截图，以满足 skill market 上传限制。请直接打开 `examples/generated/presets/` 下的 HTML 样例预览风格；这些样例同时作为可编辑运行时的 smoke fixtures。

The marketplace package intentionally excludes PNG/JPEG preview assets to satisfy binary-file upload restrictions. Open the HTML samples under `examples/generated/presets/` directly to preview styles; those files also serve as editable-runtime smoke fixtures.

推荐先看这些入口 / Recommended starting points:

- Dark / bold: `examples/generated/presets/bold-signal.html`, `examples/generated/presets/electric-studio.html`, `examples/generated/presets/creative-voltage.html`
- Light / editorial: `examples/generated/presets/notebook-tabs.html`, `examples/generated/presets/pastel-geometry.html`, `examples/generated/presets/vintage-editorial.html`
- Ported beautiful templates: `examples/generated/presets/8-bit-orbit.html`, `examples/generated/presets/broadside.html`, `examples/generated/presets/soft-editorial.html`, `examples/generated/presets/monochrome-ledger.html`

截图生成仍由脚本支持，但截图产物不应放入市场包 / Screenshot capture remains script-supported, but generated image assets should stay out of the marketplace package:
