...
// 独立心跳进程（每30s自检）
const { Heartbeat } = require('./HEARTCORE/heartbeat.js');
...
| 版本 | 日期 | 里程碑 |
|------|------|--------|
| v0.13.163 | 2026-05-15 | 修复README：heartbeat保留；更正版本号v0.13.111→v0.13.163 |
