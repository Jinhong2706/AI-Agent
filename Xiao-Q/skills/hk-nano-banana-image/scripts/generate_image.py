...
Supports text-to-image and image-to-image generation via OpenAI-HK API
"""
...
def text_to_image(api_key: str, prompt: str, model: str = "nano-banana", 
                  size: str = "16:9", quality: str = "standard", n: int = 1,
                  output: str = None) -> str:
...
def image_to_image(api_key: str, prompt: str, input_images: list,
                   model: str = "nano-banana", n: int = 1,
                   output: str = None) -> str:
    """Generate image from reference image(s) - image editing/variation."""
    import mimetypes
...
def main():
    ...
    parser.add_argument("--model", default="nano-banana", 
                        choices=["nano-banana", "nano-banana-hd", "nano-banana-2", 
    ...
    parser.add_argument("--size", default="16:9",
                        choices=["16:9", "9:16", "4:3", "3:4", "2:3", "3:2"],
                        help="Aspect ratio")
    parser.add_argument("--quality", default="standard",
                        choices=["low", "standard", "high"],
                        help="Quality (low/standard/high)")
